...
urlpatterns = [
    ...
    path('tierlists/add/', views.tierlist_create, name='tierlist_create'),
    ...
    # Tier Items
    path('tierlists/<int:tierlist_id>/items/add/', views.tieritem_create, name='tieritem_create'),
    ...
    # Atividade dos Usuários (apenas admin)
